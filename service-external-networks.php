...
<head>
  ...
  <title>Наружные сети — услуги Петроспецмонтаж</title>
  <meta name="description" content="Электроснабжение, связь, теплотрассы, водопровод и канализация на прилегающей территории.">
  ...
  <main class="article">
    <header class="article-cover">
      <div class="article-cover__media" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1621905251918-48416bd8575a?auto=format&amp;fit=crop&amp;w=1600&amp;h=700&amp;q=80" width="1600" height="700" alt="Наружные инженерные сети и промышленный объект" fetchpriority="high" decoding="async">
      </div>
      ...
      <div class="article-cover__content container">
        <nav class="breadcrumb" aria-label="Навигация по сайту">
          <a href="index.php">Главная</a><span>/</span><a href="services.php">Услуги</a><span>/</span><span>Наружные сети</span>
        </nav>
        <h1 class="article-cover__title">Наружные инженерные сети: проект и монтаж</h1>
      </div>
    </header>

    <section class="section section--article">
      <div class="container article__inner">
        <p class="article__lead">ООО «Петроспецмонтаж» выполняет работы по направлению «Наружные сети» в Санкт-Петербурге и Ленинградской области. Ниже — кратко о составе услуги и как с нами связаться.</p>
        <div class="article__body">
          <h2>Направления</h2>
          <p>Прокладка и реконструкция линий электроснабжения и связи, теплотрассы, наружное освещение, водопровод и канализация с привязкой к существующим колодцам и вводам.</p>
          <h2>Согласования</h2>
          <p>Помогаем собрать исходные допуски и пройти необходимые процедуры с ресурсоснабжающими организациями.</p>
        </div>
      ...
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="svc-service-external-networks-name">Имя</label>
            <input class="lead-form__field" type="text" id="svc-service-external-networks-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="svc-service-external-networks-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="svc-service-external-networks-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="svc-service-external-networks-msg">Сообщение</label>
            <textarea class="lead-form__field" id="svc-service-external-networks-msg" name="message" placeholder="Тип объекта, сроки, вопросы по услуге"></textarea>
