...
<head>
  ...
  <title>Металлоконструкции по проекту — производство Петроспецмонтаж</title>
  <meta name="description" content="Изготовление металлоконструкций по чертежам заказчика в СПб и ЛО.">
  ...
  <main class="article">
    <header class="article-cover">
      <div class="article-cover__media" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&amp;fit=crop&amp;w=1600&amp;h=700&amp;q=80" width="1600" height="700" alt="Строительно-монтажные работы и металлоконструкции" fetchpriority="high" decoding="async">
      </div>
      ...
      <div class="article-cover__content container">
        <nav class="breadcrumb" aria-label="Навигация по сайту">
          <a href="index.php">Главная</a><span>/</span><a href="production.php">Производство</a><span>/</span><span>Металлоконструкции</span>
        </nav>
        <h1 class="article-cover__title">Металлоконструкции по проекту</h1>
      </div>
    </header>

    <section class="section section--article">
      <div class="container article__inner">
        <p class="article__lead">Выпускаем силовые и несущие элементы по КМ и КМД: колонны, балки, связи, фермы и вспомогательные детали с учётом класса стали и требований по антикоррозионной защите.</p>
        <div class="article__body">
          <h2>Изготовление</h2>
          <p>Раскрой, сборка в прихватках, сварка по WPS, зачистка и подготовка под ЛКМ или горячее цинкование по заданию проекта.</p>
          <h2>Документация</h2>
          <p>Паспорта на сварные швы, акты входного контроля материалов и маркировка для стыковки на монтаже — по запросу в составе отгрузки.</p>
        </div>
    ...
    <section class="section service-lead" aria-labelledby="prod-metallo-lead-title">
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          <h2 id="prod-metallo-lead-title">Заказать обратный звонок</h2>
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="prod-metallo-name">Имя</label>
            <input class="lead-form__field" type="text" id="prod-metallo-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="prod-metallo-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="prod-metallo-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="prod-metallo-msg">Сообщение</label>
            <textarea class="lead-form__field" id="prod-metallo-msg" name="message" placeholder="Тип конструкций, вес металла, сроки"></textarea>
