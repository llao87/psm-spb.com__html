...
<head>
  ...
  <title>Промышленное и гражданское строительство — услуги Петроспецмонтаж</title>
  <meta name="description" content="СМР, подземные сооружения, генподряд и гидроизоляция конструкций.">
  ...
  <main class="article">
    <header class="article-cover">
      <div class="article-cover__media" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&amp;fit=crop&amp;w=1600&amp;h=700&amp;q=80" width="1600" height="700" alt="Строительно-монтажные работы" fetchpriority="high" decoding="async">
      </div>
      ...
      <div class="article-cover__content container">
        <nav class="breadcrumb" aria-label="Навигация по сайту">
          <a href="index.php">Главная</a><span>/</span><a href="services.php">Услуги</a><span>/</span><span>Строительство</span>
        </nav>
        <h1 class="article-cover__title">Промышленное и гражданское строительство</h1>
      </div>
    </header>

    <section class="section section--article">
      <div class="container article__inner">
        <p class="article__lead">ООО «Петроспецмонтаж» выполняет работы по направлению «Промышленное и гражданское строительство» в Санкт-Петербурге и Ленинградской области. Ниже — кратко о составе услуги и как с нами связаться.</p>
        <div class="article__body">
          <h2>Объёмы</h2>
          <p>Строительно-монтажные работы, подземные сооружения, малые архитектурные формы, гидроизоляция и генподряд с фиксацией сроков в договоре.</p>
          <h2>Отчётность</h2>
          <p>Ведём журнал работ и прозрачную сметную дисциплину на протяжении всего цикла.</p>
        </div>
      ...
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="svc-service-construction-name">Имя</label>
            <input class="lead-form__field" type="text" id="svc-service-construction-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="svc-service-construction-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="svc-service-construction-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="svc-service-construction-msg">Сообщение</label>
            <textarea class="lead-form__field" id="svc-service-construction-msg" name="message" placeholder="Тип объекта, сроки, вопросы по услуге"></textarea>
