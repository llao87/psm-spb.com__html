...
<body>
  ...
  <main class="article">
    ...
    <section class="section service-lead" aria-labelledby="prod-lstk-lead-title">
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          <h2 id="prod-lstk-lead-title">Заказать обратный звонок</h2>
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="prod-lstk-name">Имя</label>
            <input class="lead-form__field" type="text" id="prod-lstk-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="prod-lstk-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="prod-lstk-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="prod-lstk-msg">Сообщение</label>
            <textarea class="lead-form__field" id="prod-lstk-msg" name="message" placeholder="Марки, объём, сроки, вопросы по ЛСТК"></textarea>
