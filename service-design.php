...
<head>
  ...
  <title>Проектирование и изыскания — услуги Петроспецмонтаж</title>
  <meta name="description" content="Проектно-изыскательские работы, обследования и сметная документация в Санкт-Петербурге и ЛО.">
  ...
  <main class="article">
    <header class="article-cover">
      <div class="article-cover__media" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&amp;fit=crop&amp;w=1600&amp;h=700&amp;q=80" width="1600" height="700" alt="Проектирование и авторский надзор на объекте" fetchpriority="high" decoding="async">
      </div>
      ...
      <div class="article-cover__content container">
        <nav class="breadcrumb" aria-label="Навигация по сайту">
          <a href="index.php">Главная</a><span>/</span><a href="services.php">Услуги</a><span>/</span><span>Проектирование</span>
        </nav>
        <h1 class="article-cover__title">Проектирование и изыскания: ПД, РД и сопровождение</h1>
      </div>
    </header>

    <section class="section section--article">
      <div class="container article__inner">
        <p class="article__lead">ООО «Петроспецмонтаж» выполняет работы по направлению «Проектирование и изыскания» в Санкт-Петербурге и Ленинградской области. Ниже — кратко о составе услуги и как с нами связаться.</p>
        <div class="article__body">
          <h2>Состав работ</h2>
          <p>Обследования существующих конструкций, разработка проектной и рабочей документации, дизайн-проекты интерьеров, сметы и генпроектирование при необходимости.</p>
          <figure class="article-fig article-fig--small">
            <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&amp;fit=crop&amp;w=900&amp;h=560&amp;q=80" width="900" height="560" alt="Рабочая документация и согласования" loading="lazy" decoding="async">
            <figcaption>Типовой цикл согласований и выдачи документации.</figcaption>
          </figure>
          <h2>Как начать</h2>
          <p>Опишите объект и задачу в заявке ниже — подготовим перечень исходных данных и предложим формат сотрудничества.</p>
        </div>
      ...
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="svc-service-design-name">Имя</label>
            <input class="lead-form__field" type="text" id="svc-service-design-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="svc-service-design-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="svc-service-design-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="svc-service-design-msg">Сообщение</label>
            <textarea class="lead-form__field" id="svc-service-design-msg" name="message" placeholder="Тип объекта, сроки, вопросы по услуге"></textarea>
