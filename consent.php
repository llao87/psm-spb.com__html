...
<head>
  ...
  <title>Согласие на обработку персональных данных — Петроспецмонтаж</title>
  ...
  <main class="legal">
    <div class="container">
      <article class="legal__article">
        ...
        <p>Настоящий текст — заглушка для демонстрации многостраничной структуры. Подготовьте форму согласия совместно с юристом с учётом целей обработки (заявки, договоры, рассылки).</p>
        <p>Оператор: ООО «Петроспецмонтаж». Контакт: <a href="mailto:petrospecmontag@mail.ru">petrospecmontag@mail.ru</a>.</p>
        <p><a href="index.php">← На главную</a></p>
      </article>
    </div>
  </main>

    <section class="section service-lead" aria-labelledby="page-cb-consent-title">
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          <h2 id="page-cb-consent-title">Заказать обратный звонок</h2>
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="page-cb-consent-name">Имя</label>
            <input class="lead-form__field" type="text" id="page-cb-consent-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="page-cb-consent-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="page-cb-consent-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="page-cb-consent-msg">Сообщение</label>
            <textarea class="lead-form__field" id="page-cb-consent-msg" name="message" placeholder="Тип объекта, сроки, вопрос"></textarea>
    ...
    <div class="container footer__grid">
      ...
      <div>
        ...
        <p class="footer__legal">
          ...
          ·
          <a href="consent.php" aria-current="page">Согласие на обработку персональных данных</a>
        </p>
