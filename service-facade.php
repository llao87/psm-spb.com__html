...
<head>
  ...
  <title>Фасадные работы — услуги Петроспецмонтаж</title>
  <meta name="description" content="Строительный и монтажный фасад, штукатурка и финишная отделка в СПб и ЛО.">
  ...
  <main class="article">
    <header class="article-cover">
      <div class="article-cover__media" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&amp;fit=crop&amp;w=1600&amp;h=700&amp;q=80" width="1600" height="700" alt="Фасадные работы и архитектурный облик здания" fetchpriority="high" decoding="async">
      </div>
      ...
      <div class="article-cover__content container">
        <nav class="breadcrumb" aria-label="Навигация по сайту">
          <a href="index.php">Главная</a><span>/</span><a href="services.php">Услуги</a><span>/</span><span>Фасады</span>
        </nav>
        <h1 class="article-cover__title">Фасадные работы и отделка фасада</h1>
      </div>
    </header>

    <section class="section section--article">
      <div class="container article__inner">
        <p class="article__lead">ООО «Петроспецмонтаж» выполняет работы по направлению «Фасадные работы» в Санкт-Петербурге и Ленинградской области. Ниже — кратко о составе услуги и как с нами связаться.</p>
        <div class="article__body">
          <h2>Системы</h2>
          <p>Навесные вентилируемые фасады, мокрые фасады, утепление по слоям и финишные покрытия согласно проекту.</p>
          <h2>Контроль</h2>
          <p>Проверяем узлы на площадке, ведём журнал скрытых работ и сопровождаем приёмку.</p>
        </div>
      ...
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="svc-service-facade-name">Имя</label>
            <input class="lead-form__field" type="text" id="svc-service-facade-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="svc-service-facade-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="svc-service-facade-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="svc-service-facade-msg">Сообщение</label>
            <textarea class="lead-form__field" id="svc-service-facade-msg" name="message" placeholder="Тип объекта, сроки, вопросы по услуге"></textarea>
