...
<body>
  ...
  <main>
    ...
    <section class="section service-lead" aria-labelledby="page-cb-news-title">
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          <h2 id="page-cb-news-title">Заказать обратный звонок</h2>
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="page-cb-news-name">Имя</label>
            <input class="lead-form__field" type="text" id="page-cb-news-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="page-cb-news-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="page-cb-news-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="page-cb-news-msg">Сообщение</label>
