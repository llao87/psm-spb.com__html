      ...
      <div class="container">
        <div class="service-lead__box contact-card card--reveal">
          ...
          <form class="lead-form lead-form--stack js-lead-form" novalidate>
            <label class="sr-only" for="svc-service-landscape-name">Имя</label>
            <input class="lead-form__field" type="text" id="svc-service-landscape-name" name="name" placeholder="Имя" autocomplete="name">
            <label class="sr-only" for="svc-service-landscape-phone">Телефон</label>
            <input class="lead-form__field" type="tel" id="svc-service-landscape-phone" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required>
            <label class="sr-only" for="svc-service-landscape-msg">Сообщение</label>
            <textarea class="lead-form__field" id="svc-service-landscape-msg" name="message" placeholder="Тип объекта, сроки, вопросы по услуге"></textarea>
